package com.example.homework_spring_mongodb.feature.course.web;

import com.example.homework_spring_mongodb.feature.course.CourseService;
...
//    }
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void updateIsPaid(@PathVariable String id, @RequestBody @Valid CheckUpdateRequest checkUpdateRequest) {
        courseService.updateIsPaid(id, checkUpdateRequest);
    }
